-- Seed data for fiTech Laptop Plans
-- This file adds sample laptops to the catalog
...
-- Note: After running this seed, you can verify the data by running:
-- SELECT id, brand, model, price, stock_quantity FROM public.laptops;
